function Main()local tl={}--->>> Script Configuration ================================================================================
	...
	tl.fileLocation =  0						--[*] Does the current profile use an external file in any of the external paths?
	...
	tl.logEmpty = false								-- Should unbound or unplayed buttons also be logged into the table of past keys?
	...
	end loadfile(tl.path.."/T-lib.lua")(tl)end r,e=pcall(Main)if not(r)then OutputLogMessage("Error loading T-Lib.\n"..e..".\n")end --Main Program, do not touch
	--[[ Key Test Area
