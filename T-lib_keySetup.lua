...
tl._KEYBOARD = {
	...
	["�"]   = { { key = "equal" }                           , { key = "a" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "a", modifier = "lshift" } },
	["�"]   = { { key = "tilde" }                           , { key = "a" } },
	["�"]   = { { key = "equal" }                           , { key = "e" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "e", modifier = "lshift" } },
	["�"]   = { { key = "tilde" }                           , { key = "e" } },
	["�"]   = { { key = "equal" }                           , { key = "i" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "i", modifier = "lshift" } },
	["�"]   = { { key = "tilde" }                           , { key = "i" } },
	["�"]   = { { key = "equal" }                           , { key = "o" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "o", modifier = "lshift" } },
	["�"]   = { { key = "tilde" }                           , { key = "o" } },
	["�"]   = { { key = "equal" }                           , { key = "u" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "u", modifier = "lshift" } },
	["�"]   = { { key = "tilde" }                           , { key = "u" } },

	["�"]   = { { key = "equal" }                           , { key = "a" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "a" } },
	["�"]   = { { key = "tilde" }                           , { key = "a" } },
	["�"]   = { { key = "equal" }                           , { key = "e" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "e" } },
	["�"]   = { { key = "tilde" }                           , { key = "e" } },
	["�"]   = { { key = "equal" }                           , { key = "i" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "i" } },
	["�"]   = { { key = "tilde" }                           , { key = "i" } },
	["�"]   = { { key = "equal" }                           , { key = "o" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "o" } },
	["�"]   = { { key = "tilde" }                           , { key = "o" } },
	["�"]   = { { key = "equal" }                           , { key = "u" } },
	["�"]   = { { key = "equal", modifier = "lshift" }      , { key = "u" } },
	["�"]   = { { key = "tilde" }                           , { key = "u" } },
}
