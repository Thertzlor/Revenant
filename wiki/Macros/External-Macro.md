...
### Complete Syntax:
>`{ type="externalmacro"|"e", <name> [, p|play=<option>, macroBlocking=<boolean>, lcd=<boolean> ] }`
...
k.m3 = { type="externalmacro", "Custom Multikey", macroBlocking=true }

-- If this macro will abort any other running LGS macro before playing, preventing it from being blocked itself.
k.m4 = { type="externalmacro", "Custom Multikey", macroBlocking=false }
...
k.m3 = { type="externalmacro", "Custom Multikey", lcd = true }

-- Triggers the same macro silently.
k.m3 = { type="externalmacro", "Custom Multikey", lcd = false }
